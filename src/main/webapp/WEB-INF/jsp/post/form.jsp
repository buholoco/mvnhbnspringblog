...
<form:form method="post" action="/blog/post/add.htm" commandName="post">
	...
	<form:input path="title" placeholder="Enter title.." class="input-block-level"  htmlEscape="true"/>
    ...
    <form:input path="tags" title="Comma separate values" class="input-block-level" placeholder="Comma, Separate, Values"  htmlEscape="true"/>
