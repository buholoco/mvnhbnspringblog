...
<form:form method="post" action="/blog/contact.htm" commandName="contactType">
    ...
    <form:input path="from" placeholder="Enter your email.." class="input-block-level"  htmlEscape="true"/>
    <form:errors path="from" class="text-error" />
    
    <form:label path="subject">Subject</form:label>
    <form:input path="subject" placeholder="Enter subject.." class="input-block-level"  htmlEscape="true"/>
    <form:errors path="subject" class="text-error" />
    
    

    <form:label path="text">Body</form:label>
    <form:textarea path="text" class="input-block-level" htmlEscape="true"/>
